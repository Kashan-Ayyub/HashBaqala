                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('dashboard.category.edit' , ['id' => $item['id']]) }}"><i class="bi bi-pencil"></i></a>
                                                
                                                <a href="{{route('dashboard.category.delete' , ['id' => $item['id']])}}"><i class="mx-3 bi bi-trash3" onclick=" return confirm('Are You Sure?')"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                    <tr><td class="h4 text-center" colspan="5">Record Not Found</td></tr>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
