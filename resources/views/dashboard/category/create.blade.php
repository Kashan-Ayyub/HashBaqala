    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Category Create</h4>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.category.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control mb-3" required name="cat_name" id="exampleInputPassword1">
                              @if(session('name_exist'))
                              <span class="mt-2" style="color: red;">{{ session('name_exist') }}</span>
                              @endif
                            </div>
                            <div class="mb-3">
