            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Hash Baqala  Dashboard</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase">All Categories</h5>
                                <div class="d-flex align-items-center no-block m-t-20 m-b-10">
                                    <h1><i class="icon-tag text-purple"></i></h1>
                                    <div class="ml-auto">
                                        <h1 class="text-muted">{{ $categoryCount }}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase">All Users</h5>
                                <div class="d-flex align-items-center no-block m-t-20 m-b-10">
                                    <h1><i class="icon-user text-danger"></i></h1>
                                    <div class="ml-auto">
                                        <h1 class="text-muted">{{ $userCount }}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase">All Banners</h5>
                                <div class="d-flex align-items-center no-block m-t-20 m-b-10">
                                    <h1><i class="fa fa-image text-success"></i></h1>
                                    <div class="ml-auto">
                                        <h1 class="text-muted">{{ $bannerCount }}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
